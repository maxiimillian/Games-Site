...
function PostPreview(props) {
    return (
        ...
        <div className={styles["post-subcontainer"]}>
            ...
            <span className={styles["post-date"]}>{parseDate(props.date)} ago</span>
                <span className={styles["post-title"]}>{formatText(props.title, 100)}</span>
            </div>
            <div className={styles["post-footer"]}>
                ...
                <div className={styles["post-button-container"]}>
                    <FontAwesomeIcon className={styles["post-buttons"]} icon={faThumbsUp} size="md" />
                    <FontAwesomeIcon className={styles["post-buttons"]} icon={faCommentAlt} size="md" />
                </div>
            </div>
        </div>
        {props.tags.map(tag => {
