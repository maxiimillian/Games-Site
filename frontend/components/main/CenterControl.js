        ...
        <div className="game_option-container">
            ...
            <div className={styles["options-sidebar-container"]}>
                ...
                <div className={styles["options-container"]}>
                        ...
                        {gameIndex.map((game) => {
                            return (<section key={game.name} onClick={() => setCurrentForm(game)} className={styles["game-option"]}>
                                <Image src={game.imagePath} className={styles["game-icon"]} height="150" width="200" alt="sudoku board" />
